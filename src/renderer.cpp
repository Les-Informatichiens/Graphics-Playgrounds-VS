...
void Renderer::camera_setup_perspective(float width, float height, float fov, float _near, float _far)
{
  ...
  camera_clip_n = _near > 0.0f ? _near : distance / 10.0f;
  camera_clip_f = _far > 0.0f ? _far : distance * 10.0f;
